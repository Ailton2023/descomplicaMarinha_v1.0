...
const questions = [
  {
    question: "O comandante Romeo, ao sair para uma missão com a Fragata Papa, observou uma pequena confusão no passadiço, em função da manobra de desatracação. No auge da manobra, um dos seus motores propulsores veio a falhar originando ordem equivocada pelo seu oficial de manobra como 'Atenção proa e popa largar espias em emergência'. Percebendo a atitude precipitada de seu oficial, o comandante Romeo, em voz firme e fundamentada, ordenou: 'A manobra está comigo, Atenção Leme a meio solecar espias 1 e 6', sendo assim, é correto afirmar que, segundo o EMA-137, os seguintes atributos foram observados pelo comandante Romeo:",
    options: ["(A) senso de justiça e entusiasmo.", 
              "(B) altruísmo e flexibilidade.", 
              "(C) determinação e humildade.", 
              "(D) caráter e respeito.", 
              "(E) competência profissional e capacidade decisória."],
